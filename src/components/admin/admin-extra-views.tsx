...
import { AuthUser, StoreSettings, ResellerUser, Product, ApiConfig, PlanPricing } from '../../types';
...
export const AdminSoldKeysView: React.FC = () => {
    ...
    <div className="space-y-4" id="admin-sold-keys-view">
      <div>
        <h2 className="text-base font-extrabold text-white flex items-center gap-2">
          ...
          <span>Sold Key Live History</span>
        </h2>
        <span className="text-[11px] text-gray-400">Real-time stream of all keys generated by bot</span>
      </div>

      <GlassCard glow="green" className="p-4 bg-[#161622]/95 border-white/10 space-y-2.5">
        <div className="p-2.5 rounded-xl bg-black/40 border border-white/5 space-y-1 text-xs">
          <div className="flex items-center justify-between font-bold">
            <span className="text-white">Bala mods (1 Day VIP)</span>
            <span className="text-emerald-400 font-mono">₹60.00</span>
          </div>
          <div className="text-[10px] font-mono text-[#00e5ff] truncate">
            BALA-NR-8941-X992-VIP
          </div>
          <div className="text-[9px] text-gray-400 flex items-center justify-between pt-1 border-t border-white/5">
            <span>Buyer: @kd_123_1_3 (8282895979)</span>
            <span>Just now</span>
          </div>
        </div>
      </GlassCard>
